...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/schubert_winterreise.git
...
* `Franz Schubert – Winterreise <https://github.com/DCMLab/schubert_winterreise/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the first song, *Gute Nacht*, has the following files:
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/schubert_winterreise/issues>`__ and feel free to fork and submit pull requests.
