...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first song, *Gute Nacht*, has the following files:
